...
(1, 1, 'A WordPress Commenter', 'wapuu@wordpress.example', 'https://wordpress.org/', '', '2023-04-19 09:35:40', '2023-04-19 09:35:40', 'Hi, this is a comment.\nTo get started with moderating, editing, and deleting comments, please visit the Comments screen in the dashboard.\nCommenter avatars come from <a href=\"https://en.gravatar.com/\">Gravatar</a>.', 0, '1', '', 'comment', 0, 0);
...
(2, 'siteurl', 'http://example.org', 'yes'),
(3, 'home', 'http://example.org', 'yes'),
(4, 'blogname', 'Test Blog', 'yes'),
...
(91, 'admin_email_lifespan', '1697448940', 'yes'),
...
(105, 'cron', 'a:2:{i:1681896943;a:1:{s:32:\"recovery_mode_clean_expired_keys\";a:1:{s:32:\"40cd750bba9870f18aada2478b24840a\";a:3:{s:8:\"schedule\";s:5:\"daily\";s:4:\"args\";a:0:{}s:8:\"interval\";i:86400;}}}s:7:\"version\";i:2;}', 'yes');
...
(1, 'admin', '$P$BCiwy8JM0zEFd7eMLav4fge3sjbLjn.', 'admin', 'admin@example.org', 'http://example.org', '2023-04-19 09:35:40', '', 0, 'admin');
...
--
-- Indexes for table `wptests_commentmeta`
--
...
--
-- Indexes for table `wptests_comments`
--
...
--
-- Indexes for table `wptests_links`
--
...
--
-- Indexes for table `wptests_options`
--
...
--
-- Indexes for table `wptests_postmeta`
--
...
--
-- Indexes for table `wptests_posts`
--
...
--
-- Indexes for table `wptests_termmeta`
--
...
--
-- Indexes for table `wptests_terms`
--
...
--
-- Indexes for table `wptests_term_relationships`
--
...
--
-- Indexes for table `wptests_term_taxonomy`
--
...
--
-- Indexes for table `wptests_usermeta`
--
...
--
-- AUTO_INCREMENT for table `wptests_commentmeta`
--
ALTER TABLE `wptests_commentmeta`
  MODIFY `meta_id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `wptests_comments`
--
ALTER TABLE `wptests_comments`
  MODIFY `comment_ID` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT for table `wptests_links`
--
ALTER TABLE `wptests_links`
  MODIFY `link_id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `wptests_options`
--
ALTER TABLE `wptests_options`
  MODIFY `option_id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=106;

--
-- AUTO_INCREMENT for table `wptests_postmeta`
--
ALTER TABLE `wptests_postmeta`
  MODIFY `meta_id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;

--
-- AUTO_INCREMENT for table `wptests_posts`
--
ALTER TABLE `wptests_posts`
  MODIFY `ID` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;

--
-- AUTO_INCREMENT for table `wptests_termmeta`
--
ALTER TABLE `wptests_termmeta`
  MODIFY `meta_id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `wptests_terms`
--
ALTER TABLE `wptests_terms`
  MODIFY `term_id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT for table `wptests_term_taxonomy`
--
ALTER TABLE `wptests_term_taxonomy`
